...
namespace CliWrap
{
    ...
    public class Cli : IDisposable
    {
        ...
        private Process CreateProcess1(ExecutionInput input)
        {
            // Create process start info
            var startInfo = new ProcessStartInfo
            {
        ...
        public Task<ExecutionOutput> Execute1Async(string arguments,
           CancellationToken cancellationToken = default(CancellationToken),
           IBufferHandler bufferHandler = null)
           => Execute1Async(new ExecutionInput(arguments), cancellationToken, bufferHandler);
